...
@section('content')
    <div class="main-content" x-data="{
        ...
        filterLocations(searchTerm) {
            searchTerm = Number(searchTerm.target.value);
            axios.get(`/api/locations/${searchTerm}`)
                .then(response => this.arrivalLocations = response.data)
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form id="createtrip-form" autocomplete="off" class="needs-validation" action="{{ route('trips.store') }}"
                    method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-8">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ old('name') }}" placeholder="Enter trip name">
                                                        @error('name')
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="datetime-local" class="form-control"
                                                            ...
                                                            value="{{ old('departure_time') }}" placeholder="">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select x-model="arrivalLocationId" class="form-select mb-3"
                                                            ...
                                                            <template x-for="location in arrivalLocations"
                                                                :key="location.id">
