        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form id="createlocation-form" autocomplete="off" class="needs-validation"
                    action="{{ route('locations.update', $location->id) }} " method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-8">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ $location->name }}" placeholder="Enter location name">
                                                        @error('name')
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="code">location
                                                            Code</label>
                                                        <input type="text" class="form-control"
                                                            id="manufacturer-name-input" name="code"
                                                            value="{{ $location->code }}" placeholder="Enter location name">
                                                        @error('code')
                                                            <p class="text-danger">{{ $message }}</p>
                                                        @enderror
                                                    </div>
